...
export default function Home() {
  const bodyText =
    "I'm a full-time student at Northwestern University majoring in Computer Science and Jazz Studies, \
        ...
        <div className="text-2xl h-screen">
          ...
          <div className="first section pb-20">
            ...
            <div className="mx-auto max-w-screen-xl rounded-2xl text-center text-white px-5">
              <div className="bg-mocha/[.85] p-4 rounded-2xl">{bodyText}</div>
            </div>
          </div>
          ...
          <div
            id="projects"
            className="text-white pt-[6rem] mx-auto max-w-screen-xl"
          >
          ...
          <div
            id="contact"
            className="text-white pt-5 md:pt-[30px] px-10 mx-auto max-w-screen-xl"
          >
            <ContactMe />
          </div>
